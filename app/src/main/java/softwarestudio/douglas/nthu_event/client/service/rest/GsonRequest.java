...
import softwarestudio.douglas.nthu_event.client.service.rest.GsonResponse;
import softwarestudio.douglas.nthu_event.client.service.rest.PutExclusionStrategy;
...
public class GsonRequest<T> extends JsonRequest<GsonResponse<T>> {
    ...
    public GsonRequest(int method, String url, Map<String, String> headers, T body,
        ...
        super(method, url, gson.toJson(body), listener, errorListener);
        this.bodyCls = bodyCls;
        this.headers = headers;
    }
